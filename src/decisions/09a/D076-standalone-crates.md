...
- `ra-formats` and game-module loaders own game-specific families whose correct handling depends on EA-derived details or on render/model systems outside the classic 2D scope.
