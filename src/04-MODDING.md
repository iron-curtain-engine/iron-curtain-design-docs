...
| **Campaign System**          | Branching mission graphs, persistent state, unit roster carryover, hero progression, Lua campaign API (D021). Generated SpecOps prior art lives in `research/generated-specops-missions-study.md`; the in-book PoC lives in [generated-specops-prototype](modding/generated-specops-prototype.md) | [campaigns](modding/campaigns.md)             |
